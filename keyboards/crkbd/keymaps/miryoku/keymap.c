...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_split_3x6_3(
     KC_NO, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_ESC, \
  ...
  [_NAV] = LAYOUT_split_3x6_3(
    ...
    KC_NO, _______, KC_NO, KC_ENT, KC_BSPC, KC_DEL
  ),
  ...
  [_MOUSE] = LAYOUT_split_3x6_3(
    ...
    KC_NO, KC_NO, _______, KC_BTN1, KC_BTN2, KC_BTN3
  ),
  ...
  [_FUN] = LAYOUT_split_3x6_3(
    ...
    KC_APP, KC_SPC, KC_TAB, KC_NO, KC_NO, _______
  )
};
